...
var form = document.querySelector("form"); // Class for note
...
function showAlertMessage(message, alertClass) {
  ...
  form.insertAdjacentElement("beforebegin", alertDiv); //   titleInput.focus();
...
document.addEventListener("DOMContentLoaded", displayNotes); // Function to remove note from local storage
